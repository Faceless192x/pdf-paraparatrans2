...
def create_paragraph(lines):
    ...
    for line in lines:
        ...
        for span in line.get("spans", []):
            ...
            tab_replaced_text = span["text"].replace("\t", f'|')

            SYMBOL_FONT_NAMES = ["Symbol", "ZapfDingbats"]
            REPLACE_WITH_SYMBOL_DICT = {
                "a": "■", "b": "▲", "c": "●", "d": "◆", "e": "▼",
                "f": "○", "g": "◇", "h": "□", "i": "△", "j": "☆",
                "k": "★", "l": "※", "m": "→", "n": "←", "o": "↑",
                "p": "↓", "q": "♠", "r": "♣", "s": "♥", "t": "♦",
            ...
            is_symbol_font = span.get("font") in SYMBOL_FONT_NAMES
            if is_symbol_font:
                symbol_replaced_text = ''.join(
                    REPLACE_WITH_SYMBOL_DICT.get(ch, ch) for ch in tab_replaced_text
                )
            else:
                symbol_replaced_text = tab_replaced_text

            paragraph["src_text"] += symbol_replaced_text
